...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AXI_DST_ADDR_OFFSET" -parent ${Page_0}
  ipgui::add_param $IPINST -name "AXI_SRC_ADDR_OFFSET" -parent ${Page_0}
...
proc update_PARAM_VALUE.AXI_DST_ADDR_OFFSET { PARAM_VALUE.AXI_DST_ADDR_OFFSET } {
	# Procedure called to update AXI_DST_ADDR_OFFSET when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AXI_DST_ADDR_OFFSET { PARAM_VALUE.AXI_DST_ADDR_OFFSET } {
	# Procedure called to validate AXI_DST_ADDR_OFFSET
	return true
}

proc update_PARAM_VALUE.AXI_SRC_ADDR_OFFSET { PARAM_VALUE.AXI_SRC_ADDR_OFFSET } {
	# Procedure called to update AXI_SRC_ADDR_OFFSET when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AXI_SRC_ADDR_OFFSET { PARAM_VALUE.AXI_SRC_ADDR_OFFSET } {
	# Procedure called to validate AXI_SRC_ADDR_OFFSET
	return true
}
...
proc update_MODELPARAM_VALUE.AXI_SRC_ADDR_OFFSET { MODELPARAM_VALUE.AXI_SRC_ADDR_OFFSET PARAM_VALUE.AXI_SRC_ADDR_OFFSET } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AXI_SRC_ADDR_OFFSET}] ${MODELPARAM_VALUE.AXI_SRC_ADDR_OFFSET}
}

proc update_MODELPARAM_VALUE.AXI_DST_ADDR_OFFSET { MODELPARAM_VALUE.AXI_DST_ADDR_OFFSET PARAM_VALUE.AXI_DST_ADDR_OFFSET } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AXI_DST_ADDR_OFFSET}] ${MODELPARAM_VALUE.AXI_DST_ADDR_OFFSET}
}
